        ...
        <div class="container">
            <nav class="navbar">
                <div class="logo">
                    ...
                    <img src="{{ asset('school-images/coginitive_logo.png') }}"
        ...
        <div class="container">
            ...
            <div class="welcome-content">
                <div class="welcome-text" data-aos="fade-right">
                    ...
                    <p>At Cognitive Learning Academy, we are passionate about providing a good standard education and
            ...
            <div class="anthem-pledge-container">
                ...
                <div class="pledge" data-aos="fade-left">
                    ...
                    <div class="pledge-content">
                        <p>At Cognitive Learning Academy, our philosophy is simple yet powerful: <strong>Our students
                                are learning to excel</strong>.</p>
        ...
        <div class="container">
            ...
            <div class="testimonials-container">
                <div class="testimonial active">
                    <p class="testimonial-text">Cognitive Learning Academy has transformed my child's approach to
                        learning. The focus on e-learning and computer-based training has prepared her for the digital
                        age in ways I couldn't have imagined.</p>
                ...
                <div class="testimonial">
                    <p class="testimonial-text">As an educator myself, I appreciate how Cognitive Learning Academy
                        balances academic rigor with character development. The focus on "learning to excel" creates
    ...
    <div class="modal" id="programsModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>At Cognitive Learning Academy, we offer a continuum of educational programs designed to nurture
                    students from their earliest years through to secondary education.</p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Complete the enrollment process by submitting the required fees and documents. Your child is now
                    ready to begin their journey at Cognitive Learning Academy!</p>
    ...
    <div class="modal" id="facilitiesModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>At Cognitive Learning Academy, we've created a stimulating and safe environment where students can
                    learn, grow, and develop into well-rounded individuals. Our facilities are designed to support our
            ...
            <div class="modal-body">
                ...
                <div
                    ...
                    <p><i class="fas fa-map-marked-alt"
                        ...
                        Cognitive Learning Academy Location</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                <div class="anthem-pledge-container">
                    ...
                    <div class="pledge">
                        <h3>Our Philosophy</h3>
                        <div class="pledge-content">
                            <p>At Cognitive Learning Academy, our philosophy is simple yet powerful: <strong>Our
                                    students are learning to excel</strong>.</p>
